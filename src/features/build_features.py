...
# we split the df_temporal into subset using set column and then apply the temporal abstraction (rolling window) to each subset and concatenate the results
...
# --------------------------------------------------------------
# Dealing with overlapping windows to avoid overfitting
# --------------------------------------------------------------
