...
selected_features, orderd_features, ordered_scores = learner.forward_selection(max_features,X_train, y_train)
...
# --------------------------------------------------------------
# Try a more complex model (nn) with the selected features or feature_set_4
# --------------------------------------------------------------
